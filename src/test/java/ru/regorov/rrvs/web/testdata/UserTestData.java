...
public class UserTestData {
    ...
    public static final User USER1 = new User(USER1_ID, "tony", "user", "1qaz2wsx", Role.ROLE_USER);
    public static final User USER2 = new User(USER1_ID + 1, "regorov", "admin", "qwqwqw", Role.ROLE_USER, Role.ROLE_ADMIN);
