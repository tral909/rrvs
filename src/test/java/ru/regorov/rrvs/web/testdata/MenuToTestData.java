...
public class MenuToTestData {
    public static final int MENU_TO1_ID = 1;
    public static final int RESTAURANT1_ID = 1;

    public static final String DATE = "2019-01-26";
    public static final MenuTo MENU_TO1 = new MenuTo(MENU_TO1_ID, LocalDate.parse(DATE), RESTAURANT1_ID);
    public static final MenuTo MENU_TO2 = new MenuTo(MENU_TO1_ID + 1, LocalDate.parse(DATE), RESTAURANT1_ID + 1);
    public static final MenuTo MENU_TO3 = new MenuTo(MENU_TO1_ID + 2, LocalDate.parse(DATE), RESTAURANT1_ID + 2);
    public static final MenuTo MENU_TO4 = new MenuTo(MENU_TO1_ID + 3, LocalDate.parse(DATE), RESTAURANT1_ID + 3);
    public static final MenuTo MENU_TO5 = new MenuTo(MENU_TO1_ID + 4, LocalDate.parse(DATE), RESTAURANT1_ID + 4);
